...
(function($) {
	...
	function display(index, trigger, e) {
		...
		// alert($(window).height() + "- " + e[cur.eventPosY] + "-" +
		// $("#jqContextMenu").height());
		var winHeight = $(window).height();
		var menuHeight = $("#jqContextMenu").height();
		
		var y = e[cur.eventPosY];
//		if (y > menuHeight) {
//			y = y - (y - menuHeight) - 30;
//		}
...
//		y = y - 300;
//		alert("winHeight:" +winHeight + " menuHeight:  "+menuHeight + " y:" +y);
		menu.css({
