...
function ajml_html(field,data,path) {
	...
	for (var i=0;i<Math.ceil(data_json.length/16);i++) {
		...
		html += "<div style=\"margin-top: 0px;margin-right: 10px;float: right;\"><img src=\""+path+"/images/zf_logo.png\" width=\"60px\" height=\"70px\" /></div>";
...
function yjdjb_html(field,otherPar) {
	...
	for (var i=0;i<Math.ceil(data_json.length/13);i++) {
		...
		html += "<div style=\"margin-top: 0px;margin-right: 10px;float: right;\"><img src=\""+otherPar.path+"/images/zf_logo.png\" width=\"60px\" height=\"70px\" /></div>";
		html += "<table  cellspacing=\"0\" style=\"border-collapse: collapse; border-spacing: 0;background-color: transparent;max-width: 100%\" cellpadding=\"0\" width=\"100%\" class=\"print_font\">";
        html += "<thead>";
        html += "<tr>";
        html += "<th colspan=\"5\">";
        html += "<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\">";
        html += "<tr align=\"center\">";
        html += "<td style=\"font-size: 26px;padding-bottom: 25px;padding-top: 0px;padding-left:50px\">中纺集团档案移交登记表</td>";
        html += "</tr>";
        html += "</table>";
...
function jnml_html(field,data,ajh,bgqx,path) {
	...
	for (var i=0;i<Math.ceil(data_json.length/15);i++) {
		...
		html += "<div style=\"margin-top: 5px;margin-right: 10px;float: right;\"><img src=\""+path+"/images/zf_logo.png\" width=\"60px\" height=\"70px\" /></div>";
		html += "<table  cellspacing=\"0\" style=\"border-collapse: collapse; border-spacing: 0;background-color: transparent;max-width: 100%\" cellpadding=\"0\" width=\"100%\" class=\"print_font\">";
        html += "<thead>";
        html += "<tr>";
        html += "<th colspan=\"5\">";
