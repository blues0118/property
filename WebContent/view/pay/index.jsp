...
<script type="text/javascript">
	...
	function onClick(event, treeId,nodes) {
		...
		if (nodes.projecttype == 'L') {
			$("#fra").attr("src","${pageContext.request.contextPath}/pay/addlist.do?projectid=" + nodes.id);
			return ;
		}else{
...
<div id="bodyer">
	...
	<div id="bodyer_right">
		<iframe id="fra" name="pay" width="100%" height="100%" scrolling="yes" frameborder="0"></iframe>
	</div>
